...
# Allowed base directory for resume files — any download path must resolve within here.
_RESUME_BASE_DIR = (Path(__file__).parent.parent.parent.parent.parent / "data").resolve()
